...
class IbottaDB:
    ...
    def get_db(self, db_url, echo=False) -> Engine:
        """
    ...
    def init_db(self, engine: Engine) -> Engine:
        """
    ...
    def map_csv(self, dir: str) -> Dict[str, str]:
        """
    ...
    def load_csv(self, conn: Engine, dir: str, mapping: Dict[str, str]) -> None:
        """
        Initializes the database schema.
        ...
        """
        # Drop and recreate tables in defined schema
        self.init_db(conn)
    ...
    def run_sql(self, conn: Engine, query: str) -> Optional[List[Dict[str, Any]]]:
        """
    ...
    def run_sql_file(self, conn: Engine, path: str) -> Optional[List[Dict[str, Any]]]:
        """
